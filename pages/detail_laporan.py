...
def render():
    ...
    if not my_laporan:
        render_empty_state(
            ...
            "Kirim laporan pertama Anda melalui menu Kirim Laporan."
        )
        return
    ...
    for l in my_laporan[::-1]:
        ...
        for i, step in enumerate(STEPS):
            ...
            circle_color = "#1D4ED8" if done else "#E5E7EB"
            text_color = "#1E3A8A" if done else "#9CA3AF"
            ...
            if i < len(STEPS) - 1:
                line_color = "#1D4ED8" if i < step_idx else "#E5E7EB"
            ...
            <div class="card">
                ...
                ">
                    ...
                    <div>
                        ...
                        <span class="badge {badge_cls}" style="margin-left:8px;">
                            {l['status']}
                        </span>

                        {
                            '<span class="badge badge-blue" style="margin-left:6px;">📎 Ada Lampiran</span>'
                            if l.get('lampiran')
                            else ''
                        }
                    </div>
